  ...
  return (
    <form onSubmit={onSubmit} className="space-y-7">
      {fields.map((field) => {
        ...
        const shared =
          'w-full rounded-xl border border-cobalt-600/20 bg-white/80 px-4 py-3.5 text-base text-ink placeholder:text-ink-faint/70 transition focus:border-cobalt-600 focus:outline-none focus:ring-4 focus:ring-cobalt-600/12'
